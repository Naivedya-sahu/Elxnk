...
static const Component COMPONENTS[] = {
    ...
    {"GND", GND_commands, 20},
    {"L", L_commands, 20},
    {"NMOS", NMOS_commands, 71},
    {"NPN", NPN_commands, 41},
    {"NP_C", NP_C_commands, 16},
    {"OPAMP", OPAMP_commands, 36},
    {"PMOS", PMOS_commands, 71},
    {"PNP", PNP_commands, 41},
    {"P_C", P_C_commands, 23},
    {"R", R_commands, 25},
    {"R_TRIM", R_TRIM_commands, 37},
    {"TX", TX_commands, 72},
    {"VAC", VAC_commands, 26},
    {"VAR", VAR_commands, 28},
    {"VDC", VDC_commands, 36},
...
static const FontGlyph FONT_GLYPHS[] = {
    ...
    {'B', font_B_commands, 9},
    {'C', font_C_commands, 5},
    {'D', font_D_commands, 10},
    {'E', font_E_commands, 5},
    {'F', font_F_commands, 8},
    {'G', font_G_commands, 4},
    {'H', font_H_commands, 10},
    {'I', font_I_commands, 8},
    {'J', font_J_commands, 4},
    {'K', font_K_commands, 10},
    {'L', font_L_commands, 4},
    {'M', font_M_commands, 5},
    {'N', font_N_commands, 8},
    {'O', font_O_commands, 4},
    {'P', font_P_commands, 8},
    {'Q', font_Q_commands, 4},
    {'R', font_R_commands, 14},
    {'S', font_S_commands, 4},
    {'T', font_T_commands, 12},
    {'U', font_U_commands, 8},
    {'V', font_V_commands, 4},
    {'W', font_W_commands, 8},
    {'X', font_X_commands, 12},
    {'Y', font_Y_commands, 12},
    {'Z', font_Z_commands, 11},
};
